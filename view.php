<?php
$page_title = 'ATEM';
$page_title_actions = '<a id="atem-create-btn" class="btn btn-primary atem-btn-new d-inline-flex align-items-center" href="atem/create.php"><i class="bi bi-plus-lg me-1"></i>Create New ATEM</a>';
