(function () {
    ...
    function renderDashboard(data) {
        ...
        setWidth('bar-overdue',    barScale > 0 ? Math.round((data.overdue_count || 0) / barScale * 100) : 0);
        ...
        setText('bar-overdue-n',    data.overdue_count || 0);
    ...
    function renderDashboardOutlet(data) {
        ...
        setWidth('bar-o-overdue',    barScaleO > 0 ? Math.round((data.overdue_count || 0) / barScaleO * 100) : 0);
        ...
        setText('bar-o-overdue-n',    data.overdue_count || 0);
